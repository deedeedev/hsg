...
@click.option('-s', '--sort', type=click.Choice(['hsk', 'frequency']), default='frequency', help='Sort results by hsk or frequency.')
@click.option('-r', '--reverse', required=False, is_flag=True, default=False, help='Reverse order if sorting by hsk or frequency.')
@click.option('-h', '--max-hsk', required=False, type=click.Choice(['1', '2', '3', '4', '5', '6', '7', '7-9']), default=None, help='Show only words with specified hsk level or above.')
...
def search(query: str, exact: bool, show_traditional: bool, format: str, sort: str, reverse: bool, max_hsk: str, max_results: int, all_results: bool):
